...
class Chantier
{
    ...
    #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'chantiersDirectes')]
    #[ORM\JoinColumn(nullable: true, onDelete: 'SET NULL')]
    private ?User $chefChantier = null;
    ...
    public function setChefChantier(?User $chefChantier): static
    {
